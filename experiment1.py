...
class StrategyLearner(object):
    ...
    def addEvidence(self, symbol="JPM", \
        ...
        plt.xlabel('Date')
        plt.savefig('Experiment_1_SL.png')
...
if __name__ == "__main__":
    learner = StrategyLearner(verbose=False, impact=0.005)  # runs __init___ in qlearner
    ...
    MS = ms.ManualStrategy(verbose=False, impact=0.005)
