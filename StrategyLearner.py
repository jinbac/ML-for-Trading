...
class StrategyLearner(object): 			  		 			     			  	   		   	  			  	
    ...
    def addEvidence(self, symbol = "JPM", \
        ...
        for day in range(len(self.trades)):
            ...
            else: price_per_sma[symbol][day] = 4 # fillout nan data NOT NEEDED IF PAST DATA IMPLEMENTED !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        plt.xlabel('Date')
        plt.savefig('Strategy_Learner_in_Sample.png')
    ...
    def testPolicy(self, symbol = "JPM", \
        ...
        plt.ylabel('Normalized Portfolio Value')
        plt.xlabel('Date')
        plt.savefig('Strategy_Learner_Out_of_Sample.png')
        plt.legend(['SL Portfolio', 'Benchmark Portfolio'])
        if self.verbose:
            plt.show()
        plt.clf()
...
if __name__=="__main__":
    learner = StrategyLearner(verbose = False, impact = 0.000) # runs __init___ in qlearner
